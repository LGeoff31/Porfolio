  ...
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black overflow-hidden">
      ...
      <div className="relative z-10 pt-20 pb-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <motion.div
          className="absolute top-1/2 left-0 w-32 h-32 bg-gradient-to-r from-purple-500/5 to-pink-500/5 rounded-full blur-2xl"
          animate={{
            scale: [1, 1.2, 1],
            opacity: [0.3, 0.6, 0.3],
          }}
        ...
        <motion.div
          className="absolute bottom-20 right-0 w-40 h-40 bg-gradient-to-r from-blue-500/5 to-cyan-500/5 rounded-full blur-2xl"
          animate={{
            scale: [1, 0.8, 1],
            opacity: [0.3, 0.6, 0.3],
          }}
